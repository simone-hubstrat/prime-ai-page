  ...
  return (
    <section className="py-20 bg-gradient-to-br from-secondary/5 to-primary/5">
      <div className="container mx-auto px-4 max-w-4xl text-center">
        ...
        {/* Social Proof Grid */}
        <div className="grid md:grid-cols-3 gap-6 mb-10" data-aos="fade-up" data-aos-delay="300">
        ...
        <div className="conversion-card bg-gradient-to-r from-secondary/10 to-primary/10 border-2 border-secondary/30 max-w-lg mx-auto hover:scale-[1.02] transition-all duration-300" data-aos="zoom-in" data-aos-delay="400">
          <div className="space-y-4">
            ...
            <Button variant="secondary" size="lg" className="w-full text-xl py-6 hover:scale-[1.02] transition-all duration-300">
        ...
        {/* Final Guarantees */}
        <div className="grid md:grid-cols-3 gap-4 mt-10 text-sm" data-aos="fade-up" data-aos-delay="600">
        ...
        {/* Final Urgency */}
        <div className="mt-8 p-4 bg-secondary/10 rounded-lg border border-secondary/20 hover:scale-[1.02] transition-transform duration-300" data-aos="pulse" data-aos-delay="800">
