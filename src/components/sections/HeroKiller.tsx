...
const HeroKiller: React.FC = () => {
  ...
  return (
    <BackgroundGradientAnimation
      ...
      interactive={false}
    >
      {/* isolate + z-index per evitare bleed, overflow-hidden per contenere ombre/gradiente */}
      <section className="relative isolate z-10 overflow-hidden w-full px-4 sm:px-6 lg:px-8 pt-8 sm:pt-12 lg:pt-16 pb-clamp-safe min-h-[min(100svh,900px)]">
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-start lg:items-center">
            ...
            <div className="space-y-6 sm:space-y-8 lg:space-y-10 w-full order-2 lg:order-1" data-aos="fade-right">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 w-full">
                <div className="bg-card/80 backdrop-blur-sm p-3 sm:p-4 rounded-lg border border-border/50 text-center">
                ...
                <div className="bg-card/80 backdrop-blur-sm p-3 sm:p-4 rounded-lg border border-border/50 text-center sm:col-span-3 lg:col-span-1">
              ...
              {/* Pricing Card - CON EXTRA PADDING BOTTOM E BORDER RADIUS GARANTITI */}
              <div
                className="bg-card/80 backdrop-blur-sm w-full max-w-lg mx-auto lg:mx-0 mt-6 sm:mt-8 mb-16 sm:mb-20 lg:mb-24 p-4 sm:p-6 rounded-lg border border-border/50 shadow-[0_4px_20px_0_hsl(225_62%_7%_/_0.6),_0_0_0_1px_hsl(225_27%_25%_/_0.3)]"
                data-aos="zoom-in"
              >
