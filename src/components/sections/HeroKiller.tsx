  ...
  return (
    <section className="relative min-h-screen overflow-hidden">
      <BackgroundGradientAnimation
        ...
        gradientBackgroundEnd="rgb(45, 27, 61)"
        firstColor="67, 107, 255"
        secondColor="47, 230, 184"
        thirdColor="100, 220, 255"
        fourthColor="200, 50, 150"
        fifthColor="180, 180, 50"
        pointerColor="67, 107, 255"
        size="80%"
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-8">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="conversion-card text-center backdrop-blur-sm bg-card/30 border-white/10">
                ...
                {/* Price + CTA */}
                <div className="conversion-card bg-card/40 backdrop-blur-sm border-white/10">
              ...
              <div className="relative">
                <div className="relative backdrop-blur-sm bg-white/5 rounded-lg p-4 border border-white/10">
                  <img 
                    src={heroImage} 
